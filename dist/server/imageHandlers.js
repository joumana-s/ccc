...
async function handleResize(req, res) {
    try {
        ...
        const dest = path_1.default.join('dist/public/images/resized', path_1.default.basename(src));
        (0, utils_1.copyFileToDist)(src, dest);
        res.json({
...
async function handleDynamicResize(req, res) {
    try {
        ...
        if (fs_1.default.existsSync(cachePath)) {
            ...
            const dest = path_1.default.join('dist/public/images/resized', path_1.default.basename(cachePath));
